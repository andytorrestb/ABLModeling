...
import json
import glob
from postprocessing import process_output_directory, create_video_from_frames
...
def process_case(case_dir, generate_video=True):
    ...
    # 1. Plot generation (utilizing the library function which handles slice reading and plotting)
    # process_output_directory iterates internally. 
    # To get fine-grained timing we might need to modify it or just time the whole block.
    # For now, timing the whole block is sufficient as per requirements.
